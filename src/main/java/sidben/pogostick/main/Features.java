...
public class Features
{
    ...
    public static class Stats
    {
        ...
        public static Achievement    USE_POGOSTICK         = new Achievement(Reference.ModID + ":achievement.use_pogostick", "use_pogostick", 1, 0, Features.pogoStick, null);
        public static Achievement    BIG_FALL              = new Achievement(Reference.ModID + ":achievement.big_fall", "big_fall", 4, -1, Items.IRON_BOOTS, Stats.USE_POGOSTICK);
        ...
        public static Achievement    KILL_MONSTER          = new Achievement(Reference.ModID + ":achievement.kill_monster", "kill_monster", 1, 2, Items.IRON_SHOVEL, Stats.USE_POGOSTICK);
        public static Achievement    KILL_BOUNCING_MONSTER = new Achievement(Reference.ModID + ":achievement.kill_bouncing_monster", "kill_bouncing_monster", 3, 3, Items.ROTTEN_FLESH,
                Stats.KILL_MONSTER).setSpecial();
    }
