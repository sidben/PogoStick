...
public class PogostickHelper
{
    ...
    public static void processEntityLandingWithPogostick(@Nonnull EntityLivingBase entity, ItemStack pogoStack, float fallDistance)
    {
        ...
        if (entity.world.isRemote) {
            ...
            PogostickHelper.updateVerticalMotion(entity, fallDistance, springLevel);      // TODO: check if this should be controlled by the server
            ...
            if (entity instanceof EntityPlayer) {
                ...
                final float damageToPlayer = Math.min(ModConfig.MAX_DAMAGE_TO_PLAYER, damageToItem - pogoStack.getMaxDamage() + pogoStack.getItemDamage());
